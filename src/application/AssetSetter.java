...
//		sculpture[3] = new Sculpture(58 * TILE_SIZE ,42 * TILE_SIZE, ID.Sculpture);
		...
		for(int i=0;i<4;i++) Handler.getInstance().getAllObjects().add(sculpture[i]);	
		
		// Computer
		Handler.getInstance().getAllObjects().add(new Computer(68 * TILE_SIZE ,12 * TILE_SIZE, ID.Computer));		
		
		// Helicopter
		Handler.getInstance().getAllObjects().add(new Helicopter(86 * TILE_SIZE ,30 * TILE_SIZE, ID.Helicopter));	
		
		// Trader
		Handler.getInstance().getAllObjects().add(new Trader(34 * TILE_SIZE ,46 * TILE_SIZE, ID.Trader));	
		
		// Labels
		Handler.getInstance().getAllObjects().add(new Label(58 * TILE_SIZE ,46 * TILE_SIZE, ID.Label1));	
		Handler.getInstance().getAllObjects().add(new Label(64 * TILE_SIZE ,46 * TILE_SIZE, ID.Label2));
		Handler.getInstance().getAllObjects().add(new Label(72 * TILE_SIZE ,46 * TILE_SIZE, ID.Label3));
		Handler.getInstance().getAllObjects().add(new Label(65 * TILE_SIZE ,36 * TILE_SIZE, ID.Label4));
		
		// Keys
		Handler.getInstance().getAllObjects().add(new KeyLocker(37 * TILE_SIZE ,33 * TILE_SIZE, ID.Key1));
		Handler.getInstance().getAllObjects().add(new KeyLocker(37 * TILE_SIZE ,15 * TILE_SIZE, ID.Key2));
			
		// Doors
		Handler.getInstance().getAllObjects().add(new Door(31 * TILE_SIZE ,31 * TILE_SIZE, ID.Door1, ID.Key1));
		Handler.getInstance().getAllObjects().add(new Door(46 * TILE_SIZE ,45 * TILE_SIZE, ID.Door2, ID.Key2));
		Handler.getInstance().getAllObjects().add(new DoorJail(71 * TILE_SIZE,15 * TILE_SIZE, ID.DoorJail));
		Handler.getInstance().getAllObjects().add(new MuseumDoor(53 * TILE_SIZE ,31 * TILE_SIZE, ID.MusiumDoor ,sculpture));
	...
	public void setForDetective() {
		...
		// Weapons
		Handler.getInstance().getAllObjects().add(new PistolGun(26 * TILE_SIZE ,13 * TILE_SIZE, ID.PistolGun ,true));
		Handler.getInstance().getAllObjects().add(new Knife(16 * TILE_SIZE ,38 * TILE_SIZE, ID.Knife ,true));
		Handler.getInstance().getAllObjects().add(new PistolMagazine(16 * TILE_SIZE ,20 * TILE_SIZE, ID.PistolMagazine));
		Handler.getInstance().getAllObjects().add(new PistolMagazine(60 * TILE_SIZE ,38 * TILE_SIZE, ID.PistolMagazine));
		Handler.getInstance().getAllObjects().add(new PistolMagazine(59 * TILE_SIZE ,13 * TILE_SIZE, ID.PistolMagazine));
		Handler.getInstance().getAllObjects().add(new PistolMagazine(59 * TILE_SIZE ,33 * TILE_SIZE, ID.PistolMagazine));
		Handler.getInstance().getAllObjects().add(new PistolMagazine(61 * TILE_SIZE ,33 * TILE_SIZE, ID.PistolMagazine));
		Handler.getInstance().getAllObjects().add(new PistolMagazine(63 * TILE_SIZE ,33 * TILE_SIZE, ID.PistolMagazine));
		...
		Handler.getInstance().getAllObjects().add(new HpBottle(48 * TILE_SIZE ,13 * TILE_SIZE, ID.HpBottle));
		Handler.getInstance().getAllObjects().add(new HpBottle(66 * TILE_SIZE ,13 * TILE_SIZE, ID.HpBottle));
		Handler.getInstance().getAllObjects().add(new HpBottle(74 * TILE_SIZE ,28 * TILE_SIZE, ID.HpBottle));
		Handler.getInstance().getAllObjects().add(new HpBottle(74 * TILE_SIZE ,33 * TILE_SIZE, ID.HpBottle));
	}
